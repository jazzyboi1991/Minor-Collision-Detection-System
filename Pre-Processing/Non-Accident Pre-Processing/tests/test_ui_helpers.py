...
class UiHelperTests(unittest.TestCase):
    ...
    def test_status_sort_orders_review_and_normal_separately(self):
        paths = [Path("004.mp4"), Path("001.mp4"), Path("003.mp4"), Path("002.mp4")]
        annotations = {
            "001": VideoAnnotation("001", "001.mp4", "normal", 10, 10, 1, 30, status="normal"),
            "002": VideoAnnotation("002", "002.mp4", "normal", 10, 10, 1, 30, status="needs_review"),
            "003": VideoAnnotation("003", "003.mp4", "normal", 10, 10, 1, 30, status="in_progress"),
            "004": VideoAnnotation("004", "004.mp4", "normal", 10, 10, 1, 30, status="not_started"),
        }
        self.assertEqual(
            [path.stem for path in sort_video_paths(paths, "status", annotations)],
            ["004", "002", "003", "001"],
        )
